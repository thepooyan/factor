          ...
          <CardContent class="space-y-6">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center">
                <Input id="name" placeholder="نام شرکت خود را وارد کنید" class="text-right" dir="rtl" />
                <FaSolidBuilding class="w-5 h-5 text-gray-400 -ml-8" />
              </div>
            </div>
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center">
                <Input id="fax" placeholder="شماره فکس را وارد کنید" class="text-right" dir="rtl" />
                <FiPrinter class="w-5 h-5 text-gray-400 -ml-8" />
              </div>
            </div>
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center">
                <Input id="phone" placeholder="شماره تلفن را وارد کنید" class="text-right" dir="rtl" />
                <FiPhone class="w-5 h-5 text-gray-400 -ml-8" />
              </div>
            </div>
