...
export default function ProductsPage() {
  ...
  return (
    <div class="container mx-auto py-8 " style={{ fontFamily: "IRANSans, Tahoma" }}>
      ...
      <div class="grid grid-cols-2 md:grid-cols-2  lg:grid-cols-4 xl:px-30 gap-4 justify-center px-2 m-auto">
        <Show when={plans()}>
      ...
      <section>
        ...
        <p class="text-center text-gray-600 mb-8  mx-auto">
          این قابلیت‌ها به صورت زمان‌دار و مستقل از پلن‌های اصلی، قابل اضافه شدن
          به حساب کاربری شما هستند.
        </p>

        <div class="lg:w-8/10 px-2 m-auto">
          <Show when={features()}>
